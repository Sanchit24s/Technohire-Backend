...
const {getApplications,getApplicationById,deleteApplication,getShortlistedApplications,shortlistApplication,removeFromShortlist,deleteAllApplications,downloadCV} = require("../controllers/applicationController")
